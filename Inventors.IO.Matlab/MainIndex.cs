/*! \mainpage ITLS MatLib
 *
 * \section intro_sec Introduction
 *
 * ITLS MatLib is a library for writing matlab or octave mat files that has a small
 * and easy to learn public interface. Despites its simple interface it 
 * offers a set of powerful features for creating matlab/octave files:
 * 
 * \li Scalar, 1-, 2-, and 3-dimensional numeric arrays.
 * \li Character arrays.
 * \li Struct array's (including composite structs, such as \c record.config.sample ).
 * \li 1-, 2-, and 3-dimensional cell array's that can contain any array type (numeric, character, struct, or another cell array).
 * \li Streaming array's of any type to a 1-dimensional cell array in the file.
 * \li Jagged cell array.
 *
 ...
 * \subsection creating_files Create a Matlab file
 ...
 * </code>
 * 
 * \subsection streaming Streaming data
 ...
 * 
 * \subsection jagged_cell Jagged Cell Array's
 ...
 * </code>
 * 
 * \subsection composite_structs Composite struct array's
 ...
 * 
 * \section legal Legal
 * Matlab(T) is a registed trademark of The MathWorks, Inc.
 */
